...
- [x] 3.2 Create admin entry point `/src/admin/index.ts`
...
- [x] 5.2 Add PHPCS check script to `package.json`
...
- [x] 7.4 Create `.stylelintrc.json` configuration
...
- [x] 12.1 Create/verify `.gitignore`
